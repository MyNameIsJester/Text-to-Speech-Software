...
![Sơ đồ phân quyền hệ thống](./images/phanQuyen.png)
...
Sơ đồ minh họa GPS Trigger Flow
![Sơ đồ minh họa GPS Trigger flow](./images/GPSTriggerFlow.png)
...
Sơ đồ minh họa Playback Flow
![Sơ đồ minh họa Playback Flow](./images/playback-flow.png)
...
[sơ đồ minh hoạt luồng hoạt động Tour
![sơ đồ minh hoạt luồng hoạt động Tour](./images/tourFlow.png)
...
Sơ đồ minh họa Mobile Data Retrieval
![Sơ đồ Mobile Data Retrieval](./images/Mobile_data_retrieval_flow.png)
...
Sơ đồ minh họa Admin Management Flow
![Sơ đồ minh họa Admin Management Flow](./images/admin-management-flow.png)
